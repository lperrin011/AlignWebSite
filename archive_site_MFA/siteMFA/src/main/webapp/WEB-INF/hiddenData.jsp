...
<body>
	...
	<section class="top-page">
		...
		<div class="data" id="data">
			...
			${ !empty fileNames ? "Audio and transcription files need to have the same name !" : ""}</p>
			
			
			<p>${ !empty pbAudioType ? "The format of the audio file is not supported by the MFA. All audio formats are supported by the MFA but WAV format gives better precision." : ""} 
			...
			${ !empty pbAudioText ? "The formats of the transcription and the audio files are not supported by the MFA. " : ""}
			${ !empty end ? "Files successfully saved" : ""}
			</p>
	...
	<section class="model" id="model">
		<div class="model-item">
			...
			<form action="align" method="post" class="model-form" enctype="multipart/form-data">
				...
				<p class="error-message"> ${ !empty errorModel ? "The model imported is not valid. Please import a new model or choose a pretrained model." : ""} 
				${ !empty errorName ? "Please fill the model name" : ""} 
				${ !empty errorZip ? 'Your model is neither a zip file nor the required file. Please read the instructions above.' : ''}
				</p>
				...
				<div class="model-choice">
					<div class="checkbox">		
						<input type="checkbox" id="import-text2"> <label
							for="import-text2" class="import-text">Import your own
							dictionary</label>
					</div>
				...
				<p class="error-message"> ${ !empty errorDict ? "The dictionary imported is not valid. Please import a new dictionary or choose an existing dictionary." : ""} </p>
